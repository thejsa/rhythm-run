...
class SceneGameplayEnd : public Scene {
public:
    SceneGameplayEnd(SceneManager& a_sceneManager,
        AudioManager& a_audioManager,
        unsigned int a_gameplaySceneId,
        unsigned int a_menuSceneId);
    // SceneGameplayEnd(SceneManager& a_sceneManager, unsigned int a_spriteIndex);
    ...
    // set the player's score to be displayed
    void setScore(long a_score);
